    ...
    <Row>
      <Col sm={10}lg={{span: 4,offset:0.8}} md={8} style={{padding:"3rem 0rem 0rem 0rem"}}>
       ...
       <Container>
        ...
        <Col lg={8} md={8} style={{padding:"3rem 0rem 0rem 0rem",fontFamily:"lato"}}>{data.site.siteMetadata.introduction}
        <Col lg={12} md={8} style={{padding:"1rem 0rem 0rem 0rem",fontFamily:"lato"}}>{data.site.siteMetadata.description}</Col>
        <Col lg={12} md={8} style={{padding:"1rem 0rem 0rem 0rem",fontFamily:"lato"}}>{data.site.siteMetadata.mentoredby}</Col>
        <Col lg={12} md={8} style={{padding:"1rem 0rem 0rem 0rem",fontSize:18,fontFamily:"lato",fontWeight:'bold'}}>{data.site.siteMetadata.Interests}</Col>
        ...
        <Col lg={12} md={8} style={{padding:"0.5rem 0rem 0rem 0rem",fontFamily:"lato"}}> Eric Asch ,Associate Professor at UNC Charlotte </Col>
          </Row>
        </Col>
        <Container>
