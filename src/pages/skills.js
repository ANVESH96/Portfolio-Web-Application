...
const skillsPage = () => (
  <Layout>
   ...
   <Container style={{paddingTop:"2em",fontFamily:"lato"}}>
     <div>
       {"I build End to End solutions by leveraging"} <b>Web technologies</b> with  <b>Software development </b>best practices to represent <b>Data Analysis.</b>
       </div>
     </Container>
     {/* <skillsCard/> */}
   ...
   <Card.Header  style={{ fontSize:18 }}>Web Technologies</Card.Header>
  <Card.Body >
 ...
 <Col id="Data Analytics">
   ...
   <Card.Header  style={{ fontSize:18 }}>Data Analytics</Card.Header>
  <Card.Body >
 ...
 <Col id="Software Development">
   ...
   <Card.Header  style={{ fontSize:18 }}>Software Development</Card.Header>
  <Card.Body >
  ...
  <Card.Subtitle className="mb-2 text-muted" ><p style= {{fontSize:25}} />Software Dev Methodologies</Card.Subtitle>
    <Card.Text style= {{fontSize:14}}>
    <Row><Col>Agile</Col><Col>Rapid ProtoTyping</Col></Row> 
    </Card.Text>
